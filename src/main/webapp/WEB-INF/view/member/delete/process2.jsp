...
<script type="text/javascript">
	$().ready(function(){
		$("#deleteBtn").click(function(){
			location.href = "<c:url value="/removemember/y?token=${token}" />";
		});
		$("#nDeleteBtn").click(function(){
			location.href = "<c:url value="/removemember/n?token=${token}" />";
		});
		...
		$("#myCommunities").click(function(){
			window.open("<c:url value="/mypage/communities"/>", 
					"나의 추억들", "width=500,height=500,scrollvars=yes,resizable=no");
					//popup 띄우기
		});
